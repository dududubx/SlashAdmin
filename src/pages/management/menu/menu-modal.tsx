...
export type MenuModalProps = {
	...
	onSubmit: (values: Permission) => void;
};
...
export default function PermissionModal({
	...
	const permissions = parentData;
	const [compOptions] = useState(PAGE_SELECT_OPTIONS);
        ...
        >
          <Input />
				...
				<Form.Item<Permission>
					label="Route"
					name="route"
					rules={[{ required: true, message: "please input menu route" }]}
				>
					<Input />
				</Form.Item>
